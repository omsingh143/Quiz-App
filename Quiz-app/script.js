...
const quiz = [
    ...
    },
    {
        ...
        choices: ["<article>", "<footer>", "<div>", "<header>"],
        answer: "<div>"
    },
    {
    ...
    {
        question: "Q. Which company developed the JavaScript language?",
        choices: ["Netscape", "Microsoft", "Sun Microsystems", "Oracle"],
        answer: "Netscape"
    },
    {
        question: "Q. In JavaScript, which of the following methods is used to access an HTML element by its ID?",
        choices: ["getElementById()", "getElementsByClassName()", "querySelector()", "querySelectorAll()"],
